...
namespace TitanLeafo\ScssPhp;

use TitanLeafo\ScssPhp\Base\Range;
use TitanLeafo\ScssPhp\Colors;
use TitanLeafo\ScssPhp\Parser;
use TitanLeafo\ScssPhp\Util;
...
class Compiler
{
    ...
    protected $formatter = 'TitanLeafo\ScssPhp\Formatter\Nested';
